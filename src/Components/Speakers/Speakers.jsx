...
const Speakers = ({
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#141414] p-1 rounded-2xl opacity-0 hover:opacity-100 transition-opacity duration-300">
          <div className="text-white text-center px-2">
            ...
            {description && (
              <p className="text-[12px] text-justify mb-4">{description}</p>
            )}
      ...
      {/* Speaker Name */}
      <h2 className="text-[25px] ml-12 md:ml-0 font-medium  tracking-[-0.5px] leading-[45px] text-center text-white font-amsterdam">
        {name}
      </h2>
    </div>
  );
