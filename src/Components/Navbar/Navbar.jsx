...
const Navbar = () => {
  return (
    <nav className="bg-[rgba(20,20,20,0.5)] backdrop-blur-md border border-white/20 p-2 sm:p-3 md:p-4 lg:p-2 fixed left-0 right-0 mx-auto mt-6 max-w-[1100px] min-h-[48px] flex items-center justify-between gap-4 rounded-[60px] shadow-lg z-50">
