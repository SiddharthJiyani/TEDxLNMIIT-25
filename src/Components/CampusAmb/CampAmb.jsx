...
const CampAmb = () => {
  return (
    <div className="min-h-[60%] bg-black-900 text-white p-8 flex flex-col justify-center items-center gap-14">
       <Title text={"Campus"} red={"Ambessedor"} className="block text-[40px] md:text-5xl" />
