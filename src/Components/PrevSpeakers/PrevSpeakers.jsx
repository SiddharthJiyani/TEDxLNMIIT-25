...
const PrevSpeakers = () => {
  return (
    <div className="flex flex-col justify-around flex-wrap items-center bg-black text-[#7d7d7d] text-left">
      ...
      <div className="flex flex-wrap justify-center">
        <div className='flex'>
          ...
          <div className='hover:-translate-y-3 transition-transform duration-300'>
            <div className="m-12 group relative border-4 border-[#141414] rounded-2xl w-[250px] h-[250px] p-1 bg-[#141414] overflow-hidden">
              <img
            ...
            <h2 className="text-xl text-[#7d7d7d] text-left mt-1 pl-10">Dr. Tanu Jain</h2>
          </div>
          ...
          <div className='hover:-translate-y-3 transition-transform duration-300'>
            ...
            <h2 className="text-xl text-[#7d7d7d] text-left mt-1 pl-10">Krishnan Sunderarajan</h2>
          </div>
          ...
          <div className='hover:-translate-y-3 transition-transform duration-300'>
            ...
            <h2 className="text-xl text-[#7d7d7d] text-left mt-1 pl-10">Palakh Khanna</h2>
          </div>
        ...
        <div className='flex'>
          ...
          <div className='hover:-translate-y-3 transition-transform duration-300'>
            ...
            <h2 className="text-xl text-[#7d7d7d] text-left mt-1 pl-10">Riya Upreti</h2>
          </div>
        </div>
      </div>
    </div>
